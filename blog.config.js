...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '淡泊的宇宙', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '简介', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.szysite.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '淡泊的宇宙', // 网站关键词 英文逗号隔开
